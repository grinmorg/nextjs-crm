              ...
              <div className="flex">
                <div className="grow">
                  ...
                  <p className="text-gray-400 pb-0 text-sm mb-4 font-medium">
                    Опрес с целью привлечь новых участников в наше сообщество
                    после хакатона
                  </p>
                </div>
              </div>
                ...
                <div className="inline-flex items-center justify-center h-12 w-12 bg-sky-500/10 rounded me-3">
                  ...
                  >
                    <g
                      ...
                      strokeWidth="1.5"
                    >
                      <path d="M15.197 3.355c1.673-1.68 4.25-1.816 5.757-.305c1.506 1.512 1.37 4.1-.303 5.78l-2.424 2.433M10.047 14c-1.507-1.512-1.37-4.1.302-5.779L12.5 6.062"></path>
                      <path d="M13.954 10c1.506 1.512 1.37 4.1-.303 5.779l-2.424 2.433l-2.424 2.433c-1.673 1.68-4.25 1.816-5.757.305c-1.506-1.512-1.37-4.1.303-5.78l2.424-2.433"></path>
                    </g>
                  </svg>
                </div>
              </div>
...
function QuizCardPopover() {
  return (
    <UIPopover>
      <UIModal
        button={
          <button className="flex items-center py-1.5 px-5 text-base text-gray-500 hover:bg-slate-100 hover:text-slate-700 rounded">
            <svg
              xmlns="http://www.w3.org/2000/svg"
