...
export function UIThemeToggle() {
    ...
    return (
        <button onClick={() => setDarkMode(!darkMode)} className="w-6 h-6 text-gray-500 dark:text-violet-300 relative hover:text-violet-500 dark:hover:text-violet-600 transition">
            {darkMode ? (
